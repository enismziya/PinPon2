    ...
    public partial class StartScreen : Form
    {
        ...
        private void optianspanel_actions()
        {
            if (gamemode == 1)
            {
                ...
                p1label.Location = new Point(230, 160);
            ...
            else 
            {
                ...
                difficulty.Location = new Point(230, 270);
                ...
                middif.Location = new Point(240,310);
                ...
                harddiff.Location = new Point(240, 350);
        ...
        private void MenuActions()
        {
            ...
            startpanel.Controls.Remove(difficulty);
            startpanel.Controls.Remove(middif);
            startpanel.Controls.Remove(harddiff);
